-- Temporarily modify RLS policies to allow development mode access (corrected table names)
...
-- Drop existing policies for Laitteet table (note capital L)
...
-- Drop existing policies for Huollot table (note capital H)
